...
This repository contains the Datastory of the Team Badabob for the 2023 Applied Data Analysis Class. The associated website tells the story of our [Analysis Repository](https://github.com/epfl-ada/ada-2023-project-badabob). This website was generated using the Beautiful Jekyll template of [Daatali](https://github.com/daattali/beautiful-jekyll).
